...
public class Corona {
    public static void main(String[] args) throws IOException {
        ...
        urlBuilder.append("&" + URLEncoder.encode("ServiceKey","UTF-8") + "=" + URLEncoder.encode("xtfWJX5gNhHAq58L71pggeF%2BSd87eikAS3GgqrFuLNbL1BUFE1R06Z2lXuOUHss1JNxFu8NXjg%2Bb1UWRXFPq0w%3D%3D", "UTF-8")); /*공공데이터포털에서 받은 인증키*/
