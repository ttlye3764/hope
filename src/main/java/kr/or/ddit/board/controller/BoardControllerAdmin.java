...
public class BoardControllerAdmin {
	...
	public ModelAndView boardList(String bd_division, Map<String, String> params, ModelAndView andView,
			...
			@RequestParam(defaultValue = "1", required = false ) String currentPage, RolePaginationUtil_yun pagination,
		...
		pagination.RolePaginationUtil(request, Integer.parseInt(currentPage), Integer.parseInt(totalCount), bd_division, search_keycode, search_keyword, "/lastProject/admin/board/boardList.do");
	...
	public BoardVO boardView(String bd_division, String bd_no, String rnum, String currentPage, String search_keyword,
			String search_keycode, Map<String, String> params, ModelMap modelMap, BoardVO boardInfo) throws Exception {
	...
	public ModelAndView replyList(ModelAndView andView, String bd_no) throws Exception {
	...
	public String updateBoard(String bd_division, String bd_no, String re_no, String currentPage, String search_keyword,
			String search_keycode, BoardVO boardVO, ModelMap modelMap, @RequestParam("files") MultipartFile[] items)
			throws Exception {

		this.boardService.updateBoard(boardVO, items);

		return "redirect:/admin/board/boardView.do?bd_no=" + bd_no + "&re_no=" + re_no + "&bd_division=" + bd_division
	...
	public String deleteBoard(String bd_division, ModelMap modelMap, String bd_no) throws Exception {
	...
	public String insertBoard(String bd_division, ModelMap modelMap, BoardVO boardVO,
	...
	public ModelAndView boardForm(String bd_division, ModelAndView andView) {
	...
	public void fileDownload(String fileName, String fileNo, String fileBdNo, ModelAndView andView,
	...
	public ModelAndView insertBoardReply(HttpSession session, String re_content, String bd_no, String mem_no) {
	...
	public String updateBoardReply(HttpSession session, String re_content, String bd_no, String bd_division,
			String re_no, String currentPage, String search_keyword, String search_keycode) {
	...
	public String deleteBoardReply(HttpSession session, 
			                       String bd_no, String re_no, String bd_division) {
		...
		return "redirect:/admin/board/boardView.do?bd_no=" + bd_no + "&bd_division=" + bd_division;
	}
	
	
	// 답글 폼
	@RequestMapping("replyForm")
	public ModelAndView replyForm(String bd_division, 
			                      ModelAndView andView) {

		andView.addObject("bd_division", bd_division);
		andView.setViewName("admin/board/replyForm");
