  ...
  initCharts() {
    ...
    var options = {
      ...
      series: [
        {
          name: 'STOCK ABC',
          data: ApexDummyData.series.monthDataSeries1.prices,
        },
      ],
      title: {
      ...
      labels: ApexDummyData.series.monthDataSeries1.dates,
      xaxis: {
        type: 'datetime',
      },
      yaxis: {
    ...
    chart = new ApexCharts(document.querySelector('#spline-area'), options);
    chart.render();
    ...
    var optionsarea2 = {
      ...
      series: [
        {
          name: 'commits',
          data: ApexDummyData.githubdata.series,
        },
      ],
      yaxis: {
        tickAmount: 3,
    ...
    chart = new ApexCharts(document.querySelector('#stacked-area'), options);
    chart.render();
    ...
    for (var i = 0; i < 12; i++) {
      ts1 = ts1 + 86400000;
      var innerArr = [ts1, ApexDummyData.dataSeries[2][i].value];
      dataSet[0].push(innerArr);
    }
    for (i = 0; i < 18; i++) {
      ts2 = ts2 + 86400000;
      innerArr = [ts2, ApexDummyData.dataSeries[1][i].value];
      dataSet[1].push(innerArr);
    }
    for (i = 0; i < 12; i++) {
      ts3 = ts3 + 86400000;
      innerArr = [ts3, ApexDummyData.dataSeries[0][i].value];
    ...
    chart = new ApexCharts(document.querySelector('#area-timeSeries'), options);
    chart.render();
