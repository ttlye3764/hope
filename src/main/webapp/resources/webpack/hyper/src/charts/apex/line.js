...
class ApexLine {
  ...
  initCharts() {
    ...
    for (var i = 0; i < 120; i++) {
      ts2 = ts2 + 86400000;
      var innerArr = [ts2, ApexDummyData.dataSeries[1][i].value];
      dates.push(innerArr);
    }
    ...
    window.setInterval(function() {
      self.getNewSeries(self.lastDate, {
        min: 10,
        max: 90,
      });
