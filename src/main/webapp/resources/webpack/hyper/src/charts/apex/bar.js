...
class ApexBar {
  ...
  initCharts() {
    ...
    chart = new ApexCharts(document.querySelector('#stacked-bar'), options);
    chart.render();
    ...
    chart = new ApexCharts(document.querySelector('#negative-bar'), options);
    chart.render();
    ...
    chart = new ApexCharts(document.querySelector('#pattern-bar'), options);
    chart.render();
    ...
    options = {
      ...
      fill: {
        ...
        opacity: 0.87,
        image: {
          src: ['./public/images/small/small-4.jpg'],
          width: 466,
          height: 406,
        },
      },
    ...
    chart = new ApexCharts(document.querySelector('#image-fill-bar'), options);
    chart.render();
    ...
    chart = new ApexCharts(document.querySelector('#datalables-bar'), options);
    chart.render();
  }
  /**
