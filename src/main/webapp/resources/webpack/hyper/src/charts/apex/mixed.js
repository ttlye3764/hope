...
class ApexMixed {
  ...
  initCharts() {
    ...
    chart = new ApexCharts(document.querySelector('#line-area-mixed'), options);
    ...
    chart = new ApexCharts(document.querySelector('#all-mixed'), options);
    chart.render();
  }
  /**
