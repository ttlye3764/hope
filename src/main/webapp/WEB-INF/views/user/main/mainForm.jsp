				...
				<div class="col-md-6">
					<div class="row mt-4 mt-md-0">
						<div class="col-5 offset-1 px-2 mb-3 align-self-end">
							<img class="border-radius-3 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s" src="${pageContext.request.contextPath }/resources/template/assets/images/service/01.jpg" alt="">
						</div>
						<div class="col-6 px-2 mb-3">
							<img class="border-radius-3 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.6s" src="${pageContext.request.contextPath }/resources/template/assets/images/service/02.jpg" alt="">
						</div>
						...
						<div class="col-5 align-self-start pl-2 mb-3">
							<img class="border-radius-3 wow fadeInDown" data-wow-duration="0.8s" data-wow-delay="0.2s" src="${pageContext.request.contextPath }/resources/template/assets/images/service/03.jpg" alt="">
						</div>
					</div>
				</div>
				<!-- right -->
	...
	<section class="why-us p-0">
		<div class="container">
			<div class="row no-gutters">
				<!--why us left-->
				<div class="col-lg-6 d-none d-lg-block bg-light" style="background:url(${pageContext.request.contextPath }/resources/template/assets/images/bg/05.jpg) no-repeat; background-size:cover;">
				</div>
				<!--why us right-->
					...
					<div class="portfolio-wrap grid items-3 items-padding">
						...
						<div class="portfolio-card isotope-item digital">
							<div class="portfolio-card-body">
								...
								<div class="portfolio-card-footer">
									<a class="full-screen" href="${pageContext.request.contextPath }/resources/template/assets/images/portfolio/01.jpg" data-fancybox="portfolio" data-caption="Fly in time"><i class="ti-fullscreen"></i></a>
						...
						<div class="portfolio-card isotope-item photo">
							<div class="portfolio-card-body">
								...
								<div class="portfolio-card-footer">
									<a class="full-screen" href="${pageContext.request.contextPath }/resources/template/assets/images/portfolio/02.jpg" data-fancybox="portfolio" data-caption="Waiting window"><i class="ti-fullscreen"></i></a>
						...
						<div class="portfolio-card isotope-item digital marketing">
							<div class="portfolio-card-body">
								...
								<div class="portfolio-card-footer">
									<a class="full-screen" href="${pageContext.request.contextPath }/resources/template/assets/images/portfolio/03.jpg" data-fancybox="portfolio" data-caption="Green Book"><i class="ti-fullscreen"></i></a>
						...
						<div class="portfolio-card isotope-item digital">
							<div class="portfolio-card-body">
								...
								<div class="portfolio-card-footer">
									<a class="full-screen" href="${pageContext.request.contextPath }/resources/template/assets/images/portfolio/04.jpg" data-fancybox="portfolio" data-caption="Reebok Sneakers"><i class="ti-fullscreen"></i></a>
						...
						<div class="portfolio-card isotope-item photo">
							<div class="portfolio-card-body">
								...
								<div class="portfolio-card-footer">
									<a class="full-screen" href="${pageContext.request.contextPath }/resources/template/assets/images/portfolio/05.jpg" data-fancybox="portfolio" data-caption="Parking garage"><i class="ti-fullscreen"></i></a>
						...
						<div class="portfolio-card isotope-item digital marketing photo">
							<div class="portfolio-card-body">
								...
								<div class="portfolio-card-footer">
									<a class="full-screen" href="${pageContext.request.contextPath }/resources/template/assets/images/portfolio/06.jpg" data-fancybox="portfolio" data-caption="The Pink Chair"><i class="ti-fullscreen"></i></a>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="owl-carousel owl-grab arrow-hover arrow-gray" data-margin="80" data-arrow="true" data-dots="false" data-items-xl="6" data-items-lg="5" data-items-md="4" data-items-sm="3" data-items-xs="2" data-autoplay="3000">
						<div class="item"><img src="${pageContext.request.contextPath }/resources/template/assets/images/clients/01.png" alt=""></div>
						<div class="item"><img src="${pageContext.request.contextPath }/resources/template/assets/images/clients/02.png" alt=""></div>
						<div class="item"><img src="${pageContext.request.contextPath }/resources/template/assets/images/clients/03.png" alt=""></div>
						<div class="item"><img src="${pageContext.request.contextPath }/resources/template/assets/images/clients/04.png" alt=""></div>
						<div class="item"><img src="${pageContext.request.contextPath }/resources/template/assets/images/clients/05.png" alt=""></div>
						<div class="item"><img src="${pageContext.request.contextPath }/resources/template/assets/images/clients/06.png" alt=""></div>
						<div class="item"><img src="${pageContext.request.contextPath }/resources/template/assets/images/clients/07.png" alt=""></div>
						<div class="item"><img src="${pageContext.request.contextPath }/resources/template/assets/images/clients/08.png" alt=""></div>
					</div>
				</div>
			</div>
		</div>
						...
						<div class="col-md-10 col-lg-6 mx-md-auto align-self-center">
							<div class="text-left">
								...
								<div class="d-flex mt-3">
									<h6 class="align-self-start mr-3"><img class="rounded-circle" src="${pageContext.request.contextPath }/resources/template/assets/images/thumbnails/avatar-01.jpg" alt="avatar"></h6>
					...
					<div class="row">
						<div class="col-md-10 col-lg-6 mx-md-auto align-self-center">
							<div class="text-left">
								...
								<div class="d-flex mt-3">
									<h6 class="align-self-start mr-3"><img class="rounded-circle" src="${pageContext.request.contextPath }/resources/template/assets/images/thumbnails/avatar-03.jpg" alt="avatar"></h6>
									<div class="align-self-center">
