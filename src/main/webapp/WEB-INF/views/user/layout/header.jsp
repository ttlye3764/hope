...
<body >
${publicKeyMap['publicModulus']} | ${pulicKeyMap['publicExponent'] }
				...
				<ul class="nav navbar navbar-top-links navbar-right mbn">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li class="divider"></li>
							<li><a href="${pageContext.request.contextPath }/user/join/freeboardlogout.do"><i class="fa fa-key"></i>로그아웃</a></li>
						</ul>
					</li>
				</ul>
			</div>
...
$(function(){
	...
	if(eval('${!empty param.message}')){
     ...
     $('#loginBTN').click(function(){
        ...
        var $frm = $('<form action="${pageContext.request.contextPath }/user/join/freeboardloginCheck.do" method="post"></form>');
