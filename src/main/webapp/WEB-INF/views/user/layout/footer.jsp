	...
	<div class="footer-content pb-3"  >
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4">
					<div class="widget">
						<a href="${pageContext.request.contextPath}/user/main/mainForm.do" class="footer-logo"> <!-- footer SVG logo Start -->
					...
					<div class="widget address"
						...
						<ul class="list-unstyled">
							...
							<li class="media mb-3"><i class="mr-3 display-8 ti-time"></i>
								<p>
									Mon - Fri: <strong>09:00 - 21:00</strong> <br>Sat & Sun: <strong>Closed</strong>
								</p></li>
						</ul>
					</div>
				</div>
