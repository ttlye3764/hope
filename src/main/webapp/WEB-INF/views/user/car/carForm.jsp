      ...
      <div class="container">
         <div class="row all-text-white">
            <div class="col-md-12 align-self-center">
               <h1 class="innerpage-title">내 차 정보 등록</h1>
   ...
   <form name="carForm" method="post" action="${pageContext.request.contextPath}/user/car/insertMycar.do">
      <table style="border: none" align="center">
		<tr>            
            ...
            <td>
            <input type="text" class="form-control" id="car_kinds" name="car_kinds"/>
            </td>
            <td width="150px"></td>
         </tr>
         <tr>            
        ...
        <tr>            
            ...
            <td>
            <input type="text" class="form-control" id="car_date" name="car_date"/>
            </td>
            <td width="150px"></td>
         </tr>
         <tr>            
         ...
         <tr>
            <td class="btnGroup" colspan="3" align="center">
               <input id="btn1" type="submit" value="저장"/>               
               &nbsp;&nbsp;&nbsp;&nbsp;
