<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarCollapse">
					<ul class="navbar-nav ml-auto">
						...
						<!-- Menu item 3 Pages-->
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle active" href="#" id="pagesMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pages</a>
							<ul class="dropdown-menu" aria-labelledby="pagesMenu">
								<li> <a class="dropdown-item" href="about-classic.html">About Classic</a></li>
								<li> <a class="dropdown-item active" href="about-advance.html">About Advance</a> </li>
		...
		<div class="container py-7">
			<div class="row all-text-white pb-7">
				<div class="col-12 col-lg-8">
					<h1 class="innerpage-title">We are a creative agency specializing in all your branding needs</h1>
					<h6 class="subtitle mb-4">We are a creative studio focusing on branding &amp; web design</h6>
				</div>
			</div>
		</div>
		<svg width="100%" height="100%" version="1.1" xmlns="http://www.w3.org/2000/svg" class="wave"><defs></defs><path id="wave-one" d="M 0 66.6691548173774 C 90.60000000000001 78.44066876389263 90.60000000000001 78.44066876389263 181.20000000000002 72.55491179063502 C 271.8 66.6691548173774 271.8 66.6691548173774 362.40000000000003 77.54816457015006 C 453.00000000000006 88.42717432292271 453.00000000000006 88.42717432292271 543.6 79.90462630325348 C 634.2 71.38207828358425 634.2 71.38207828358425 724.8000000000001 78.80111711074252 C 815.4000000000001 86.2201559379008 815.4000000000001 86.2201559379008 906 79.13436839902221 L 906 3943.28125 L 0 3943.28125 Z" fill="#fff"></path></svg>
		<svg width="100%" height="100%" version="1.1" xmlns="http://www.w3.org/2000/svg" class="wave"><defs></defs><path id="wave-two" d="M 0 52.00648548975518 C 113.25000000000001 65.30472189206618 113.25000000000001 65.30472189206618 226.50000000000003 58.65560369091069 C 339.75000000000006 52.00648548975518 339.75000000000006 52.00648548975518 453.00000000000006 57.34679977600448 C 566.2500000000001 62.68711406225376 566.2500000000001 62.68711406225376 679.5000000000001 49.2833820285428 C 792.7500000000001 35.87964999483185 792.7500000000001 35.87964999483185 906.0000000000001 57.34679977600448 L 906.0000000000001 3943.2812499999995 L 0 3943.2812499999995 Z" fill="rgba(255, 255, 255, .8)"></path></svg>
	<div id="jarallax-container-0" style="position: absolute; top: 0px; left: 0px; width: 100%; height: 100%; overflow: hidden; pointer-events: none; z-index: -100;"><div style="background-position: 50% 50%; background-size: cover; background-repeat: no-repeat; background-image: url(&quot;https://img.youtube.com/vi/dRj5Xfjh7Dk/maxresdefault.jpg&quot;); position: fixed; top: 0px; left: 0px; width: 1777px; height: 826.5px; overflow: hidden; pointer-events: none; margin-top: 107.25px; transform: translate3d(0px, -44.9141px, 0px); display: none;"></div><iframe id="VideoWorker-0" frameborder="0" allowfullscreen="1" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" title="YouTube video player" width="640" height="360" src="https://www.youtube.com/embed/dRj5Xfjh7Dk?autohide=1&amp;rel=0&amp;autoplay=0&amp;playsinline=1&amp;iv_load_policy=3&amp;modestbranding=1&amp;controls=0&amp;showinfo=0&amp;disablekb=1&amp;enablejsapi=1&amp;widgetid=1" style="position: fixed; top: 0px; left: 0px; right: 0px; bottom: 0px; width: 1469.33px; height: 1226.5px; max-width: none; max-height: none; margin: -92.75px 0px 0px -281.667px; z-index: -1; transform: translate3d(0px, -102.25px, 0px);"></iframe></div></div>
	<!-- =======================
	Banner innerpage -->
			...
			<div class="row">
				<div class="col-md-6 align-self-center">
					<div class="text-center text-sm-center text-md-right mb-4">
						<h2 class="text-grad display-1 font-weight-bold mb-0">15+ Years</h2>
				...
				<div class="col-md-6 align-self-center text-center text-sm-center text-md-left">
					<p class="pr-0 pr-lg-5">A Full portfolio Digital Creative Agency Specializing in: Video Production, Web Design, Branding, Brand Strategy, Content Marketing and Aerial Cinematography. sequi, obcaecati temporibus laboriosam</p>
					<p class="pr-0 pr-lg-5">We are an insight and behaviour driven creative marketing agency deleniti delectus fugiat commodi facere atque molestias sequi obcaecati temporibus laboriosam?</p>
				...
				<div class="col-lg-6 col-md-12 bg-dark px-4 py-5 p-lg-5 text-white">
					<div class="h-100">
						<div class="title text-left p-0">
							<span class="pre-title">Ok! So why our client trust us?</span>
							<h2 class="text-white">We Provide best of the best solutions for any of your business needs!</h2>
						...
						<div class="row">
							<div class="col">
								<ul class="list-group list-group-borderless mb-0">
									<li class="list-group-item text-white"><i class="fa fa-check"></i>We provide ipsum dolor sit amet</li>
									<li class="list-group-item text-white"><i class="fa fa-check"></i>consectetur adipisicing elit sed do </li>
									<li class="list-group-item text-white"><i class="fa fa-check"></i>eiusmod tempor incididunt ut labore </li>
									<li class="list-group-item text-white"><i class="fa fa-check"></i>magna et dolore aliqua Ut enim ad </li>
								</ul>
							</div>
							<div class="col">
								<ul class="list-group list-group-borderless mb-0">
									<li class="list-group-item text-white"><i class="fa fa-check"></i>commodo exea consequat Duis aute </li>
									<li class="list-group-item text-white"><i class="fa fa-check"></i>irure dolor in reprehenderit voluptate</li>
									<li class="list-group-item text-white"><i class="fa fa-check"></i>velit esse cillum dolore eu fugiat nulla</li>
									<li class="list-group-item text-white"><i class="fa fa-check"></i>Excepteur sint occaecat cupidatat non.</li>
								</ul>
							</div>
						</div>
					</div>
			...
			<div class="row testimonials ">
				...
				<div class="col-lg-6 col-md-12 bg-light px-4 py-5 p-lg-5">
					<div class="h-100">
						...
						<div class="row">
							<div class="owl-carousel testi-full dots-dark owl-grab owl-loaded owl-drag" data-arrow="false" data-items="1" data-autoplay="3800">
								<!-- testimonial item -->
							...
							<div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2754px, 0px, 0px); transition: all 0.8s ease 0s; width: 6426px;"><div class="owl-item cloned" style="width: 888px; margin-right: 30px;"><div class="item">
									<div class="testimonials-wrap">
										<div class="testi-avatar"> <img src="assets/images/thumbnails/avatar-02.jpg" alt="avatar"> </div>
										<div class="testi-text">
											<p>Thanks for the super quick support consectetur adipisicing elit. Numquam aliquid neque voluptates veniam laborum dolore porro totam iusto ipsam eligendi officia repellat ipsum commodi aspernatur quibusdam, doloremque nam ullam labore.</p>
											<span><i class="fa fa-quote-left text-primary display-7"></i></span>
											<h6 class="mb-0 mt-3">Peter Smith</h6>
											<h6 class="small">Buyer</h6>
										</div>
									</div>
								</div></div><div class="owl-item cloned" style="width: 888px; margin-right: 30px;"><div class="item">
									<div class="testimonials-wrap">
										<div class="testi-avatar"> <img src="assets/images/thumbnails/avatar-03.jpg" alt="avatar"> </div>
										<div class="testi-text">
											<p>You guys did an amazing work for me. consectetur adipisicing elit. Numquam aliquid neque voluptates veniam laborum dolore porro totam iusto ipsam eligendi officia repellat ipsum commodi aspernatur doloremque ullam labore.</p>
											<span><i class="fa fa-quote-left text-primary display-7"></i></span>
											<h6 class="mb-0 mt-3">Emma Watson</h6>
											<h6 class="small">Human Resource</h6>
										</div>
									</div>
								</div></div><div class="owl-item" style="width: 888px; margin-right: 30px;"><div class="item">
									<div class="testimonials-wrap">
								...
								</div></div><div class="owl-item active" style="width: 888px; margin-right: 30px;"><div class="item">
									<div class="testimonials-wrap">
										<div class="testi-avatar"> <img src="assets/images/thumbnails/avatar-02.jpg" alt="avatar"> </div>
										<div class="testi-text">
											<p>Thanks for the super quick support consectetur adipisicing elit. Numquam aliquid neque voluptates veniam laborum dolore porro totam iusto ipsam eligendi officia repellat ipsum commodi aspernatur quibusdam, doloremque nam ullam labore.</p>
				...
				<!--testimonials right-->
				<div class="col-lg-6 d-none d-lg-block bg-light p-0" style="background:url(assets/images/bg/04.jpg) no-repeat; background-size:cover;">
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row justify-content-between align-items-center">
				...
				<div class="col-lg-6 col-md-12">
					<div class="title text-left pb-0">
						...
						<p>With years of experience Incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. </p>
						<a class="btn btn-grad mr-3" href="#">Explore services!</a>
				...
				<div class="col-md-6">
					<div class="row mt-4 mt-md-0">
						...
						<div class="col-5 align-self-end pl-2 mb-3">
							<img class="border-radius-3 wow fadeInDown" data-wow-duration="0.8s" data-wow-delay="0.2s" src="assets/images/service/01.jpg" alt="" style="visibility: visible; animation-duration: 0.8s; animation-delay: 0.2s; animation-name: fadeInDown;">
						</div>
						...
						<div class="col-5 px-2 mb-3">
							<img class="border-radius-3 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.6s" src="assets/images/service/04.jpg" alt="" style="visibility: visible; animation-duration: 0.8s; animation-delay: 0.6s; animation-name: fadeInRight;">
						</div>
					</div>
				</div>
			</div>
	...
	<!-- =======================
	newsletter -->
	<section class="about-newsletter bg-overlay-dark-8 parallax-bg" style="background: none center center / cover;" data-jarallax-original-styles="background:url(assets/images/bg/03.jpg) center center; background-size:cover; ">
		<div class="container">
			<div class="row">
				<div class="col-12 col-lg-8 mx-auto">
					<div class="title title-light text-center">
						<span class="pre-title">Stay connected </span>
				...
				<div class="col-12 col-md-8 col-lg-5 mx-auto text-center">
					<form>
						<div class="input-group">
							<input class="form-control border-radius-right-0 border-right-0 bg-transparent text-white" type="text" name="search" placeholder="Enter your email...">
							<button type="button" class="btn btn-grad border-radius-left-0 mb-0">Subscribe now!</button>
						</div>
					</form>
				</div>
			</div>
		</div>
	<div id="jarallax-container-1" style="position: absolute; top: 0px; left: 0px; width: 100%; height: 100%; overflow: hidden; pointer-events: none; z-index: -100;"><div style="background-position: 50% 50%; background-size: cover; background-repeat: no-repeat; background-image: url(&quot;file:///Users/jaeho/developer/bootstrap/wizixo-1.1.0/template/assets/images/bg/03.jpg&quot;); position: fixed; top: 0px; left: 0px; width: 906px; height: 684.5px; overflow: hidden; pointer-events: none; margin-top: 178.25px; transform: translate3d(0px, 278.25px, 0px);"></div></div></section>
	<!-- =======================
	newsletter -->
						...
						<div class="widget">
							<a href="index.html" class="footer-logo">
								...
								<svg class="footer-logo-item" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="x