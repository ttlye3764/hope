		...
		<div class="container">
			...
			<div id="div_dietMem">
				...
				<div class="col-md-6 mb-5" style="width:390px; !important">
					<div class="accordion accordion-primary" id="dietMemDetail" style="width:390px; !important">
						<!-- item -->
						...
						<div class="accordion-item">
							...
							<div class="collapse" id="collapse-${status.count }" data-parent="#dietMemDetail" style="">
...
// 현재
$.ajax({
	url : '${pageContext.request.contextPath}/user/diet/deitMemGraphList',
	error : function(result){
		alert('dietMemGraphList 출력');
	},
	success : function(result){
		
		$('#Line_Controls_Chart').empty();
		
		chartDrowFun.chatDrow(result);
    ...
    chartDrow : function(){
        ...
        function drawDashboard() {
          ...
          for(var i = 0; i <= 29; i++){ //랜덤 데이터 생성
              ...
              dataRow = [new Date('2020', '09', i , '10'), man, woman , total];
              data.addRow(dataRow);
          }
