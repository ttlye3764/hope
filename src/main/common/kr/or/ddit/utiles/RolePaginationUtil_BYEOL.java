...
public class RolePaginationUtil_BYEOL {
	...
	private void makePagination() {
		...
		if((this.currentPage - 1) == 0){
			...
			this.pagingHtmls.append("<li class='page-item disabled'><a href='" + requestURI + "?currentPage="+ (this.currentPage -1) +"' ><span class='page-link' style='height:43 !important;'>&laquo;</span></a></li>");
		}
		//|1|2|3|4|5|
...
//			this.pagingHtmls.append("<li><a href='" + requestURI + "?currentPage="+ (this.currentPage +1) +"'>&raquo;</a></li>");
			this.pagingHtmls.append("<li class='page-item disabled'><a href='" + requestURI + "?currentPage="+ (this.currentPage +1) +"'><span class='page-link' style='height:43 !important;'>&raquo;</span></a></li>");
		}else{
